...
[![Flutter 3.47.4](https://img.shields.io/badge/Flutter-3.47.4-02569B.svg)](https://flutter.dev/)
[![Dart 3.13.3](https://img.shields.io/badge/Dart-3.13.3-0175C2.svg)](https://dart.dev/)
...
**0.65.6.** The Android 10+ and Linux desktop applications are
...
Interactive Brokers Flex CSV. Imports are duplicate-safe, atomic and undoable
...
Requires Flutter **3.47.4** (pinned — see [`localPipeline.sh`](localPipeline.sh)).
